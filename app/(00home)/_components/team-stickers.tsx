...
export const TeamStickers = async () => {
  ...
  return (
    <div className="w-full inline-flex flex-nowrap max-w-7xl mx-auto overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)] mt-8">
