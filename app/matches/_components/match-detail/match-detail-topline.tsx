...
export const MatchDetailTopLine = ({ match }: { match: MatchAPIResult }) => {
  return (
    <div className="grid grid-cols-8 md:grid-cols-10 gap-4 md:gap-0 shadow-md p-2 items-center bg-primary text-primary-foreground">
      <div className="col-span-2">
        <span className="p-1 font-over text-sm md:text-sm whitespace-nowrap">
